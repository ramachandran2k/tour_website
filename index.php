   ...
   <div class="container">
      <div class="row g-4 g-lg-5 align-items-end">
         ...
         <div class="col-12 col-sm-6 col-lg-4 offset-lg-2">
            <div class="section-heading">
               <p class="mb-0">At Express Travel, we believe in the transformative power of travel. As avid explorers
            ...
            <div class="featured-destination-card wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
               ...
               <div class="overlay-content d-flex flex-wrap gap-4 align-items-end justify-content-between">
                  <div>
                     ...
                     <h4 class="mb-0 text-white">Manhattan</h4>
                  </div>
                  <!-- Badge -->
                  <span class="badge bg-success"><span class="counter">30</span> Tours</span>
               </div>
            </div>
         </div>
         ...
         <div class="col-12 col-sm-6 col-lg-4">
            <div class="featured-destination-card wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
               ...
               <div class="overlay-content d-flex flex-wrap gap-4 align-items-end justify-content-between">
                  <div>
                     <p class="mb-1 text-white">Travel To</p>
                     <h4 class="mb-0 text-white">Pearland</h4>
                  </div>
                  <!-- Badge -->
                  <span class="badge bg-success"><span class="counter">40</span> Tours</span>
               </div>
            </div>
         </div>
         ...
         <div class="col-12 col-sm-6 col-lg-4">
            <div class="featured-destination-card wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
               ...
               <div class="overlay-content d-flex flex-wrap gap-4 align-items-end justify-content-between">
                  <div>
                     <p class="mb-1 text-white">Travel To</p>
                     <h4 class="mb-0 text-white">New York</h4>
                  </div>
                  <!-- Badge -->
                  <span class="badge bg-success"><span class="counter">25</span> Tours</span>
               </div>
            </div>
         </div>
      ...
      <div class="row justify-content-center">
         <div class="col-12 col-lg-8">
            ...
            <div class="section-heading text-center">
               <span class="sub-title text-success">Explore The World</span>
               <h2 class="mb-0">Awesome Trip with us</h2>
            </div>
         </div>
      </div>
         ...
         <div class="col-12 col-md-6 col-lg-4">
            <div class="trip-card wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
               ...
               <div class="trip-body">
                  ...
                  <!-- Button -->
                  <a href="tour-details.html" class="btn btn-light w-100">Book Now</a>
               </div>
            </div>
         </div>
...
<section class="deals-section">
   ...
   <div class="countdown-timer">
      <img class="wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms"
         src="assets/img/core-img/50-off.png" alt="">

      <!-- Countdown Clock -->
      <ul class="list-unstyled flex-wrap justify-content-center wow fadeInUp" data-wow-delay="500ms"
         data-wow-duration="1000ms" id="countdownClock" data-target-date="2025-12-31" data-target-time="23:59:59">
   ...
   <div class="deals-content">
      ...
      <div class="d-flex flex-wrap justify-content-between gap-5 align-items-center">
         <div class="section-heading">
            <span class="sub-title text-success">Deals &amp; Offers</span>
            <h2 class="mb-0 text-white">Last-Minute Deals</h2>
         </div>
         ...
         <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
               <div class="deals-slide">
                  ...
                  <!-- Deals Content -->
                  <div class="d-flex flex-wrap mt-3 gap-3 justify-content-between align-items-center">
                     <div>
                        <h4 class="mb-1">Nepal City</h4>
                        <p class="mb-0">$160</p>
                     </div>
                     <span class="badge bg-success"><i class="ti ti-star"></i> 4.9</span>
                  </div>
               </div>
            </div>
...
<section class="blog-section">
   ...
   <div class="container">
      <div class="row g-5 align-items-end">
         ...
         <div class="col-12 col-sm-6">
            <div class="section-heading">
               <span class="sub-title text-success">News &amp; Updates</span>
               <h2 class="mb-0">Our Latest News &amp; Articles</h2>
            </div>
         </div>
         ...
         <div class="col-12 col-sm-6">
            <div class="text-sm-end">
               <a href="blog-grid.html" class="btn btn-success">View All Blogs <i class="icon-arrow-right"></i></a>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="row g-4">
         ...
         <div class="col-12 col-md-7 col-xxl-8">
            <div class="d-flex gap-4 flex-column">
               <!-- Blog Card -->
               <div class="blog-card wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                  <div class="post-img">
                  ...
                  <div class="post-body">
                     ...
                     <a class="post-title h4" href="blog-details.html">The Ultimate Guide to Traveling When You Have
                        No Money</a>
               ...
               <!-- Blog Card -->
               <div class="blog-card wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
                  <div class="post-img">
