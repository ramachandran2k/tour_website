            ...
            <div class="col-12 col-lg-6">
               <div class="about-content ps-md-5">
                  <div class="section-heading">
                     <span class="sub-title text-success">About Us</span>
                  ...
                  <div class="d-flex flex-column gap-4 mb-5">
                     ...
                     <div class="about-card-sm d-flex align-items-center gap-3">
                        ...
                        <div>
                           ...
                           <p class="mb-0">At Express Travel, we believe in the transformative power of travel avid
                  ...
                  <!-- Button -->
                  <a href="about-us.html" class="btn btn-success">More About Us <i class="icon-arrow-right"></i></a>
               </div>
            </div>
         </div>
      </div>
...
<section class="success-story-section bg-light">
   <div class="divider"></div>
   <div class="container">
      <div class="row justify-content-center">
         <div class="col-12 col-xl-8">
            <div class="section-heading text-center">
               <span class="sub-title text-success">Success Story</span>
               <h2 class="mb-4">Our Journey of Excellence</h2>
               <p class="mb-0">From humble beginnings to becoming a trusted travel brand, our success story is powered by passion, perseverance, and the trust of our valued customers. We’ve helped thousands explore the world with confidence and unforgettable experiences.</p>
            </div>
         </div>
      </div>
      ...
      <div class="row g-5 align-items-center mt-5">
         <div class="col-12 col-lg-6">
            <div class="success-image wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1000ms">
               <img src="https://blog.marketingwords.com/wp-content/uploads/2020/11/success-stories.jpg" alt="Success Story" class="img-fluid rounded-4 shadow">
            </div>
         </div>
         <div class="col-12 col-lg-6">
            <div class="success-content ps-md-5">
               <h3 class="mb-3">10+ Years of Trusted Travel</h3>
               <p class="mb-4">What began as a small team of adventurers has grown into a full-scale travel company with global recognition. We've served over <strong>25,000+</strong> happy travelers across <strong>50+ destinations</strong> with top-rated guides and premium services.</p>
               <ul class="list-unstyled d-flex flex-column gap-3">
                  <li><i class="ti ti-check text-success me-2"></i> 25,000+ Happy Customers</li>
                  <li><i class="ti ti-check text-success me-2"></i> 50+ Global Destinations</li>
                  <li><i class="ti ti-check text-success me-2"></i> Rated 4.9/5 on Trusted Platforms</li>
                  <li><i class="ti ti-check text-success me-2"></i> 24/7 Customer Support</li>
               </ul>
               <a href="#" class="btn btn-success mt-4">Explore Our Milestones <i class="icon-arrow-right"></i></a>
            </div>
         </div>
      </div>
   </div>
   ...
   <section class="why-choose-section style-two bg-secondary">
      ...
      <div class="container">
         <div class="row g-5 align-items-center">
            ...
            <!-- Why Choose Content -->
            <div class="col-12 col-lg-6">
               <div class="why-choose-content ps-xxl-5">
                  <div class="section-heading">
                     <span class="sub-title text-success">Why Choose Us</span>
                     <h2 class="mb-4">Amazing Featured Tour Package the World</h2>
                     <p class="mb-5">At Express Travel, we believe in the transformative power of travel. As avid
                        explorers ourselves, we understand the desire to uncover.we understand the desire to uncover.
                     </p>
                  </div>

                  <div class="d-flex flex-column gap-4 mb-5">
                     <!-- Single Item -->
                     <div class="about-card-sm d-flex align-items-center gap-2 gap-sm-3">
                        <div class="icon">
                           <svg xmlns="http://www.w3.org/2000/svg" width="39" height="40" viewBox="0 0 39 40"
                              fill="none">
                              <path
                        ...
                        <h4 class="mb-0">Safety First Always</h4>
                        <div class="line"></div>
                     ...
                     <div class="about-card-sm d-flex align-items-center gap-2 gap-sm-3">
                        ...
                        <h4 class="mb-0">Adventure and Climbing</h4>
                        <div class="line"></div>
                        <p class="mb-0">We believe in the power of travel As avid explorer.</p>
                     </div>
                  </div>
                  ...
                  <!-- Button -->
                  <a href="about-us.html" class="btn btn-success">Explore More <i class="icon-arrow-right"></i></a>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="container">
         <div class="row justify-content-center">
            <div class="col-12 col-xl-6">
               <div class="section-heading text-center">
                  <span class="sub-title text-warning">Meet With Guide</span>
      ...
      <div class="container">
         <div class="row g-5">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
               <div class="team-card wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms">
                  <div class="team-thumb mb-4">
                     <img src="assets/img/bg-img/64.jpg" alt="">
                     <!-- Team Social -->
            ...
            <div class="col-12 col-sm-6 col-lg-3">
               <div class="team-card wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1000ms">
                  <div class="team-thumb mb-4">
                     <img src="assets/img/bg-img/65.jpg" alt="">
                     <!-- Team Social -->
                     <div class="team-social">
                        <a href="#"><i class="ti ti-brand-facebook"></i></a>
                        <a href="#"><i class="ti ti-brand-x"></i></a>
   ...
   <!-- Contact Section -->
   <section class="contact-section" style="background-image: url('assets/img/bg-img/34.jpg');">
      <!-- Divider -->
      <div class="divider"></div>
         ...
         <div class="row g-5">
            <div class="col-12 col-lg-6 order-2 order-lg-0">
               <div class="section-heading">
                  ...
                  <h2 class="mb-4 text-white">Do You Need Help For Your Next Projects?</h2>
                  <p class="text-white mb-5">At Express Travel, we believe in the transformative power of travel. As
                     avid explorers ourselves, we understand the desire to uncover experiences, forge understand the
                     desire meaningful.</p>
               </div>
      ...
      <div class="container">
         <div class="row g-5 align-items-end">
            <div class="col-12 col-sm-6">
               <!-- Section Heading -->
               <div class="section-heading">
                  <span class="sub-title text-success">Testimonial</span>
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide testimonial-card" style="background-image: url('assets/img/bg-img/24.jpg');">
                  ...
                  <div class="testimonial-content">
                     ...
                     <p class="testimonial-text">“Working with several word the templates the last years only can say
                        this is best every level
                        use it for my reviews that I hav already are company and reviews that I hav already are company
                        and the reviews that I have already are all excellent.</p>
   ...
   <div class="follow-instagram-section">
      <!-- Follow Instagram Swiper -->
      <div class="swiper follow-instagram-swiper">
         <div class="swiper-wrapper align-items-center">

            <!-- Follow Instagram Card -->
            <div class="swiper-slide">
               <div class="follow-instagram-card theme-two">
